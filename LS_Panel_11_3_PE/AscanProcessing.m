clc; clear; close all;
filepath = ("C:\Users\humve\Desktop\LS_Panel_11_3_PE");
...
labels = {'t','r','u','s','c1','n','d1','o','p','q','f','g','h','i','j','a','b','c','d','e','w','a1','e1','e2','e3','e4','e5','l','v','k','x','y','m','z','b1','ref0','ref1','ref2','ref3','ref4','ref5','ref6','ref7'};

figure(10)
plot(1:43, RMSvec, "LineWidth", 2); hold on; grid on;
text(1:43, RMSvec, labels,'VerticalAlignment','bottom');
