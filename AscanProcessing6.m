...
figure(17);
subplot(2, 1, 1);
plot(time*1e6, abs(testMatrix(:,1)), 'LineWidth', 1.2); grid on; hold on;
plot(time*1e6, abs(testMatrix(:,43)), 'LineWidth', 1.2); grid on; hold on;
title('Non timegated');
subplot(2, 1, 2);
plot(time*1e6, abs(adaptiveTgate1(:,1)), 'LineWidth', 1.2); grid on; hold on;
plot(time*1e6, abs(adaptiveTgate2(:,1)), 'LineWidth', 1.2); grid on; hold on;
plot(time*1e6, abs(adaptiveTgate1(:,43)), 'LineWidth', 1.2); grid on; hold on;
plot(time*1e6, abs(adaptiveTgate2(:,43)), 'LineWidth', 1.2); grid on; hold on;
title('timegated');